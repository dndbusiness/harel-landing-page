...
def about():
    hero = page_hero(
        ...
        "רוב הלווים בישראל מקבלים הצעה אחת, מגוף אחד, ומשווים אותה לכלום. "
        "אנחנו עושים את העבודה שאין להם זמן או גישה לעשות: מציגים את אותו תיק לעשרות גופים, "
        ...
        ["אומרים לא כשהעסקה לא טובה ללקוח",
         ...
         "פועלים תחת רישיון מרשות שוק ההון"],
        "לדבר איתנו")
    ...
    compliance = ('<div style="background:linear-gradient(165deg,#103A4A,#0A2733);'
                  ...
                  'אנחנו פועלים ברישיון מטעם רשות שוק ההון, הביטוח והחיסכון, '
...
def contact():
    ...
    form = ('<div style="background:linear-gradient(165deg,#103A4A,#0A2733);'
            ...
            '<span>מאשר/ת שיצרו איתי קשר בטלפון, בוואטסאפ ובאימייל בנוגע לפנייה זו. '
    ...
    details = ('<div style="display:flex;flex-direction:column;gap:22px">'
               ...
               % (row("phone", "טלפון", '<span class="ph">[מספר טלפון]</span>', "לחיוג ישיר בשעות הפעילות"),
                  row("mail", "אימייל", '<span class="ph">[כתובת אימייל]</span>', "מענה תוך יום עסקים"),
...
def mobile_home():
    ...
    chips = "".join(
        ...
        for t in ["בדיקה ללא עלות", "בלי פגיעה בדירוג", "לא משלמים אם לא לוקחים"])
    ...
    hero = ('<section style="background:%s"><div class="wrap" style="padding-block:40px 44px">'
            ...
            'ומביאים את המסלול הזול ביותר שאתם באמת זכאים לו.</p>'
    ...
    steps = "".join(
        ...
        for i, (t, d) in enumerate([
            ...
            ("בניית התיק", "אוספים מסמכים ומרכיבים את הבקשה כך שתתקבל."),
    ...
    cta = ('<section style="padding-block:44px;background:radial-gradient(120%% 60%% at 50%% 0,'
           ...
           '<div class="consent"><span class="box"></span>'
           '<span>מאשר/ת שיצרו איתי קשר בנוגע לפנייה זו.</span></div>'
    ...
    foot = ('<footer style="padding-block:26px"><div class="wrap" style="text-align:center">'
            ...
            'בעל רישיון למתן שירותי אשראי מטעם רשות שוק ההון, הביטוח והחיסכון, '
            'רישיון מס׳ <span class="ph">[מספר רישיון]</span>. '
            'אי־עמידה בפירעון ההלוואה עלולה לגרור חיוב בריבית פיגורים והליכי הוצאה לפועל.</p>'
